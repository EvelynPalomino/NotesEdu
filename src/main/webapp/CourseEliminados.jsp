...
<body class="sb-nav-fixed">
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">Cursos Inactivas</h1>
					<div class="card-body">
	...
	let frmId_course = document.getElementById('frmId_course');
	...
	// Funcion fnEditar
	function fnRestaurar(id_course) {
		Swal.fire(
		  'Good job!',
	...
	function fnBtnActualizar() {
		...
		xhttp.open("GET", "CourseHistorial", true);
		xhttp.onreadystatechange = function() {
			if (this.readyState == 4 && this.status == 200) {
				...
				arreglo.forEach(function(item) {
							...
							detalleTabla += "<td>";
							detalleTabla += "<a class='btn btn-success' href='javascript:fnRestaurar(" + item.id_course + ");'><i class='fa-solid fa-trash-arrow-up'></i></a> ";
